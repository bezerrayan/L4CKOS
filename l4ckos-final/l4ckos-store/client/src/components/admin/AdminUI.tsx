...
const styles: Record<string, CSSProperties> = {
  headerShell: {
    ...
    background: "radial-gradient(circle at top left, rgba(239,68,68,0.13), transparent 35%), linear-gradient(180deg, rgba(255,255,255,0.035), rgba(255,255,255,0.008)), #0b0b0b",
  ...
  statCard: {
    ...
    padding: "16px",
    borderRadius: 14,
    background: "linear-gradient(180deg, rgba(255,255,255,0.028), rgba(255,255,255,0.006)), #0b0b0b",
    minHeight: 116,
  },
  statIconWrap: {
    width: 40,
  ...
  surface: {
    ...
    borderRadius: 16,
    border: "1px solid rgba(255,255,255,0.07)",
    background: "linear-gradient(180deg, rgba(255,255,255,0.022), rgba(255,255,255,0.006)), #0c0c0c",
